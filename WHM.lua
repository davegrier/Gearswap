...
function init_gear_sets()
    ...
    sets.midcast.FastRecast = {
        ...
        body="Ebers Briault",hands="Helios Gloves",ring1="Prolix Ring",ring2="Weatherspoon Ring",
    ...
    sets.midcast.CureSolace = {main="Ababinili +1",sub="Achaq Grip",ammo="Incantor Stone",
        head="Ebers Cap",neck="Orison Locket",ear1="Glorious Earring",ear2="Nourishing Earring +1",
        body="Ebers Briault",hands="Ebers Mitts",ring1="Ephedra Ring",ring2="Sirona's Ring",
        back="Pahtli Cape",waist="Cognizant Belt",legs="Ebers Pantaloons",feet="Ebers Duckbills"}

    sets.midcast.Cure = {main="Ababinili +1",sub="Achaq Grip",ammo="Incantor Stone",
        head="Ebers Cap",neck="Orison Locket",ear1="Glorious Earring",ear2="Nourishing Earring +1",
        body="Ebers Briault",hands="Ebers Mitts",ring1="Ephedra Ring",ring2="Sirona's Ring",
        back="Pahtli Cape",waist="Cognizant Belt",legs="Ebers Pantaloons",feet="Ebers Duckbills"}

    sets.midcast.Curaga = {main="Ababinili +1",sub="Achaq Grip",ammo="Incantor Stone",
        head="Ebers Cap",neck="Orison Locket",ear1="Glorious Earring",ear2="Nourishing Earring +1",
        body="Ebers Briault",hands="Ebers Mitts",ring1="Ephedra Ring",ring2="Sirona's Ring",
        back="Pahtli Cape",waist="Cognizant Belt",legs="Ebers Pantaloons",feet="Ebers Duckbills"}

    sets.midcast.CureMelee = {main="Ababinili +1",sub="Achaq Grip",ammo="Incantor Stone",
        head="Ebers Cap",neck="Orison Locket",ear1="Glorious Earring",ear2="Nourishing Earring +1",
        body="Ebers Briault",hands="Ebers Mitts",ring1="Ephedra Ring",ring2="Sirona's Ring",
        back="Pahtli Cape",waist="Cognizant Belt",legs="Ebers Pantaloons",feet="Ebers Duckbills"}
    ...
    sets.midcast.BarElement = {main="Ababinili +1",sub="Achaq Grip",ammo="Incantor Stone",
    ...
    sets.midcast.Regen = {main="Ababinili +1",sub="Achaq Grip",ammo="Incantor Stone",
    ...
    sets.idle = {main="Bolelabunga",sub="Genbu's Shield",ammo="Incantor Stone",
        head="Ebers Cap",neck="Orison Locket",ear1="Glorious Earring",ear2="Nourishing Earring +1",
        body="Ebers Briault",hands="Ebers Mitts",ring1="Ephedra Ring",ring2="Sirona's Ring",
        back="Pahtli Cape",waist="Cognizant Belt",legs="Assiduity Pants +1",feet="Herald's Gaiters"}
