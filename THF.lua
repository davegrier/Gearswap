...
function init_gear_sets()
    ...
    sets.buff['Trick Attack'] = {ammo="Qirmiz Tathlum",
        head="Pillager's Bonnet",neck="Asperity Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Pillager's Vest",hands="Pillager's Armlets",ring1="Stormsoul Ring",ring2="Epona's Ring",
        back="Atheling Mantle",waist="Patentia Sash",legs="Pillager's Culottes",feet="Plunderer's Poulaines"}
    ...
    sets.precast.JA['Feint'] = {legs="Assassin's Culottes"}
    ...
    sets.precast.Waltz = {ammo="Sonia's Plectrum",
        head="Whirlpool Mask",
        body="Pillager's Vest",hands="Pillager's Armlets",ring1="Asklepian Ring",ring2="Valseur's Ring",
        back="Iximulew Cape",waist="Caudata Belt",legs="Pillager's Culottes",feet="Plunderer's Poulaines"}
	...
	ear2="Loquacious Earring",hands="Thaumas Gloves",ring1="Prolix Ring",ring2="Weatherspoon Ring",
	legs="Enif Cosciales"}
    ...
    sets.precast.WS = {ammo="Jukukik Feather",
        ...
        back="Rancorous Mantle",waist="Fotia Belt",legs="Manibozho Brais",feet="Taeon Boots"}
    ...
    sets.idle = {ammo="Honed Tathlum",
        ...
        body="Taeon Tabard",hands="Taeon Gloves",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Canny Cape",waist="Patentia Sash",legs="Taeon Tights",feet="Trotter Boots"}
