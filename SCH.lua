...
function init_gear_sets()
    ...
    sets.precast.FC = {main="Marin Staff", sub="Wizzan Grip",ammo="Incantor Stone",
        ...
        back="Swith Cape",waist="Witful Belt",legs="Helios Spats",feet="Academic's Loafers"}

    sets.precast.FC['Enhancing Magic'] = set_combine(sets.precast.FC, {head="Umuthi Hat",waist="Siegel Sash"})

    sets.precast.FC.Cure = set_combine(sets.precast.FC, {
	main="Tamaxchi",sub="Genbu's Shield",body="Heka's Kalasiris",back="Pahtli Cape"})
    ...
    sets.midcast.FastRecast = {ammo="Incantor Stone",
	    head="Helios Band",neck="Orunmila's Torque",ear2="Loquacious Earring",
        body="Helios Jacket",hands="Helios Gloves",ring1="Prolix Ring",ring2="Weatherspoon Ring",
        back="Swith Cape",waist="Goading Belt",legs="Helios Spats",feet="Academic's Loafers"}

    sets.midcast.Cure = {main="Tamaxchi",sub="Genbu's Shield",ammo="Incantor Stone",
        head="Telchine Cap",neck="Noetic Torque",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body="Telchine Chasuble",hands="Telchine Gloves",ring1="Ephedra Ring",ring2="Sirona's Ring",
        back="Pahtli Cape",waist="Cognizant Belt",legs="Academic's Pants",feet="Academic's Loafers"}

    sets.midcast.CureWithLightWeather = {main="Tamaxchi",sub="Genbu's Shield",ammo="Incantor Stone",
        head="Telchine Cap",neck="Noetic Torque",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body="Telchine Chasuble",hands="Telchine Gloves",ring1="Ephedra Ring",ring2="Sirona's Ring",
        back="Pahtli Cape",waist="Cognizant Belt",legs="Telchine Braconi",feet="Academic's Loafers"}

    sets.midcast.Curaga = sets.midcast.Cure

    sets.midcast.Regen = {main="Bolelabunga",sub="Genbu's Shield",
	    head="Arbatel Bonnet",body="Telchine Chasuble"}
    ...
    sets.midcast['Enhancing Magic'] = {ammo="Savant's Treatise",
        head="Arbatel Bonnet",neck="Noetic Torque",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body="Telchine Chasuble",hands="Telchine Gloves",ring1="Aquasoul Ring",ring2="Sirona's Ring",
        back="Merciful Cape",waist="Olympus Sash",legs="Academic's Pants",feet="Regal Pumps"}
    ...
    sets.midcast.IntEnfeebles = {main="Marin Staff",sub="Mephitis Grip",range="Aureole",
        head="Helios Band",neck="Noetic Torque",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body={ name="Hagondes Coat", augments={'Phys. dmg. taken -3%','Mag. Acc.+25',}},
		hands={ name="Hagondes Cuffs", augments={'Phys. dmg. taken -4%','Mag. Acc.+22',}},
		ring1="Spiral Ring",ring2="Sangoma Ring",
        back="Refraction Cape",waist="Salire Belt",legs="Helios Spats",feet="Helios Boots"}

    sets.midcast.ElementalEnfeeble = sets.midcast.IntEnfeebles

    sets.midcast['Dark Magic'] = {main="Keraunos",sub="Mephitis Grip",ammo="Dosis Tathlum",
        head="Helios Hat",neck="Stoicheion Medal",ear1="Friomisi Earring",ear2="Barkarole Earring",
        body={ name="Hagondes Coat", augments={'Phys. dmg. taken -3%','"Mag.Atk.Bns."+25',}},
		hands="Helios Gloves",ring1="Fenrir Ring",ring2="Acumen Ring",
        back="Bookworm's Cape",waist="Salire Belt",legs="Hagondes Pants",feet="Helios Boots"}

    sets.midcast.Kaustra = {main="Keraunos",sub="Wizzan Grip",ammo="Dosis Tathlum",
        head="Hagondes Hat",neck="Stoicheion Medal",ear1="Friomisi Earring",ear2="Barkarole Earring",
        body={ name="Hagondes Coat", augments={'Phys. dmg. taken -3%','"Mag.Atk.Bns."+25',}},
		hands="Helios Gloves",ring1="Fenrir Ring",ring2="Acumen Ring",
        back="Bookworm's Cape",waist="Salire Belt",legs="Hagondes Pants",feet="Helios Boots"}

    sets.midcast.Drain = {main="Keraunos",sub="Mephitis Grip",ammo="Dosis Tathlum",
        head="Helios Hat",neck="Stoicheion Medal",ear1="Friomisi Earring",ear2="Barkarole Earring",
        body={ name="Hagondes Coat", augments={'Phys. dmg. taken -3%','"Mag.Atk.Bns."+25',}},
		hands="Helios Gloves",ring1="Fenrir Ring",ring2="Acumen Ring",
        back="Bookworm's Cape",waist="Salire Belt",legs="Hagondes Pants",feet="Helios Boots"}
    ...
    sets.midcast.Stun = {main="Marin Staff",sub="Mephitis Grip",ammo="Incantor Stone",
        head="Helios Band",neck="Noetic Torque",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body={ name="Hagondes Coat", augments={'Phys. dmg. taken -3%','Mag. Acc.+25',}},
		hands="Gendewitha Gages",ring1="Prolix Ring",ring2="Sangoma Ring",
    ...
    sets.midcast['Elemental Magic'] = {main="Keraunos",sub="Wizzan Grip",ammo="Dosis Tathlum",
        head="Hagondes Hat",neck="Stoicheion Medal",ear1="Friomisi Earring",ear2="Barkarole Earring",
        body={ name="Hagondes Coat", augments={'Phys. dmg. taken -3%','"Mag.Atk.Bns."+25',}},
		hands="Helios Gloves",ring1="Fenrir Ring",ring2="Acumen Ring",
        back="Bookworm's Cape",waist="Salire Belt",legs="Hagondes Pants",feet="Helios Boots"}
    ...
    sets.midcast['Elemental Magic'].HighTierNuke = set_combine(sets.midcast['Elemental Magic'], {sub="Wizzan Grip", ammo="Erlene's Notebook"})

    sets.midcast['Elemental Magic'].HighTierNuke.Resistant = set_combine(sets.midcast['Elemental Magic'].Resistant, {sub="Wizzan Grip"})

    sets.midcast.Impact = {main="Keraunos",sub="Wizzan Grip",ammo="Dosis Tathlum",
        head=empty,neck="Stoicheion Medal",ear1="Friomisi Earring",ear2="Barkarole Earring",
        body="Twilight Cloak", hands="Helios Gloves",ring1="Fenrir Ring",ring2="Acumen Ring",
        back="Bookworm's Cape",waist="Salire Belt",legs="Hagondes Pants",feet="Helios Boots"}
    ...
    sets.idle.Field.PDT = {main="Terra's Staff",sub="Wizzan Grip",ammo="Incantor Stone",
        head="Hagondes Hat +1",
    body={ name="Hagondes Coat", augments={'Phys. dmg. taken -3%','Mag. Acc.+25',}},
    hands={ name="Hagondes Cuffs", augments={'Phys. dmg. taken -4%','Mag. Acc.+22',}},
    legs="Hagondes Pants",
    ...
    sets.idle.Field.Stun = {main="Marin Staff",sub="Mephitis Grip",ammo="Incantor Stone",
        head="Helios Band",neck="Noetic Torque",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body={ name="Hagondes Coat", augments={'Phys. dmg. taken -3%','Mag. Acc.+25',}},
		hands="Gendewitha Gages",ring1="Prolix Ring",ring2="Sangoma Ring",
        back="Refraction Cape",waist="Witful Belt",legs="Pedagogy Pants",feet="Academic's Loafers"}
    ...
    sets.defense.PDT = {main="Terra's Staff",sub="Wizzan Grip",ammo="Incantor Stone",
        head="Hagondes Hat +1",
    body={ name="Hagondes Coat", augments={'Phys. dmg. taken -3%','Mag. Acc.+25',}},
    hands={ name="Hagondes Cuffs", augments={'Phys. dmg. taken -4%','Mag. Acc.+22',}},
    legs="Hagondes Pants",
    ...
    sets.defense.MDT = {main="Terra's Staff",sub="Wizzan Grip",ammo="Incantor Stone",
        head="Hagondes Hat +1",
    body={ name="Hagondes Coat", augments={'Phys. dmg. taken -3%','Mag. Acc.+25',}},
    hands={ name="Hagondes Cuffs", augments={'Phys. dmg. taken -4%','Mag. Acc.+22',}},
    legs="Hagondes Pants",
